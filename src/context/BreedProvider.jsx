...
const BreedProvider = ({children}) =>{
    ...
    const getFeaturedBreeds = async () =>{
        const {data} = await axios('https://api.thecatapi.com/v1/images/search?has_breeds=1&limit=15&api_key=live_lqJRQZIbWnK0OyN6kiBad4pzmPMxJB5JK9gx6OQXlChpOHANqazbwIXBwZU8t7tl')
        // console.log(data)
